...
void ImGui_SetStyle(const ImGuiStyle_t imguiStyle)
{
	...
	default:
	{
		colors[ImGuiCol_Text] = ImVec4(0.81f, 0.81f, 0.81f, 1.00f);
		colors[ImGuiCol_TextDisabled] = ImVec4(0.56f, 0.56f, 0.56f, 1.00f);
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.46f, 0.28f, 0.67f, 0.50f); // purple highlight
		colors[ImGuiCol_WindowBg] = ImVec4(0.13f, 0.12f, 0.15f, 1.00f); // dark purple-ish
		colors[ImGuiCol_ChildBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.78f);
		colors[ImGuiCol_PopupBg] = ImVec4(0.11f, 0.10f, 0.14f, 1.00f);
		colors[ImGuiCol_Border] = ImVec4(0.67f, 0.50f, 0.75f, 0.50f); // soft lavender
		colors[ImGuiCol_BorderShadow] = ImVec4(0.04f, 0.04f, 0.04f, 0.00f);
		colors[ImGuiCol_FrameBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.78f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.10f, 0.06f, 0.14f, 1.00f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.13f, 0.07f, 0.18f, 1.00f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.48f, 0.29f, 0.67f, 1.00f); // purple title
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.48f, 0.29f, 0.67f, 1.00f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.11f, 0.10f, 0.14f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.16f, 0.14f, 0.20f, 1.00f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.40f, 0.28f, 0.55f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.52f, 0.35f, 0.70f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.56f, 0.38f, 0.75f, 1.00f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.47f, 0.33f, 0.60f, 1.00f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.60f, 0.40f, 0.78f, 1.00f);
		colors[ImGuiCol_Button] = ImVec4(0.40f, 0.28f, 0.55f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.52f, 0.35f, 0.70f, 1.00f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.56f, 0.38f, 0.75f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(0.40f, 0.28f, 0.55f, 1.00f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.52f, 0.35f, 0.70f, 1.00f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.56f, 0.38f, 0.75f, 1.00f);
		colors[ImGuiCol_Separator] = ImVec4(0.53f, 0.53f, 0.57f, 0.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.81f, 0.81f, 0.81f, 0.50f);
		colors[ImGuiCol_Tab] = ImVec4(0.40f, 0.28f, 0.55f, 1.00f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.52f, 0.35f, 0.70f, 1.00f);
		colors[ImGuiCol_TabActive] = ImVec4(0.56f, 0.38f, 0.75f, 1.00f);
		colors[ImGuiCol_TableHeaderBg] = ImVec4(0.16f, 0.12f, 0.20f, 1.00f);
		colors[ImGuiCol_TableBorderStrong] = ImVec4(0.24f, 0.18f, 0.30f, 1.00f);
		colors[ImGuiCol_TableBorderLight] = ImVec4(0.28f, 0.20f, 0.35f, 1.00f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.11f, 0.10f, 0.14f, 1.00f);
